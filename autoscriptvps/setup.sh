...
</strong> <p style="text-align:center"><b> <br><font color="#00FFE2"<br>┏━━━━━━━━━━━━━━━┓<br> Th3£lit3<br>┗━━━━━━━━━━━━━━━┛<br></font><br><font color="#00FF00"></strong> <p style="text-align:center"><b> <br><font color="#00FFE2">क═══════क⊹⊱✫⊰⊹क═══════क</font><br><font color='#FFFF00'><b> ★ [ ༆Hʸᵖᵉʳ᭄W̺͆E̺͆L̺͆C̺͆O̺͆M̺͆E̺͆
T̺͆O̺͆ M̺͆Y̺͆ S̺͆E̺͆R̺͆V̺͆E̺͆R̺͆ V͇̿I͇̿P͇̿ ] ★ </b></font><br><font color="#FFF00">£lit3</font><br> <font color="#FF00FF">❖No DDOS</font><br> <font color="#FF0000">❖No Torrent</font><br> <font color="#FFB1C2">❖No Bokep </font><br> <font color="#FFFFFF">❖No Hacking</font><br>
<font color="#00FF00">❖No Mining</font><br> <font color="#00FF00">➳TH3£lit3</font><br>
<font color="#00FFE2">क═══════क⊹⊱✫⊰⊹क═══════क</font><br></font><br><font color="FFFF00">❖Ƭʜᴇ quieter u become the more u are able to hear.</font><br>
END
clear
...
cd /etc/nginx 
rm -fr nginx.conf
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com//jamleowz/scriptvpsre/blob/main/autoscriptvps/nginx.conf"
cd
...
#Install OpenVPN
cd
wget -q https://raw.githubusercontent.com/jamleowz/scriptvpsre/main/autoscriptvps/package/vpn.sh && chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /usr/bin/ws "https://raw.githubusercontent.com/jamleowz/scriptvpsre/main/autoscriptvps/package/ws.py"
...
wget -O /usr/bin/loop "https://raw.githubusercontent.com/jamleowz/scriptvpsre/main/autoscriptvps/package/quota.sh"
...
wget -O /usr/bin/server "https://raw.githubusercontent.com//jamleowz/scriptvpsre/main/autoscriptvps/package/server"
...
# Install OHP Server
wget -O /root/ohp.sh "https://raw.githubusercontent.com//jamleowz/scriptvpsre/main/autoscriptvps/package/ohp.sh"
chmod +x /root/ohp.sh
cd /root
./ohp.sh
rm -fr /root/*
...
echo -e "\033[96m_______________________________\033[0m"
sleep 1.5read -rp "Masukkan Domain: " domain
#read -p "Nameserver: " nsdomain
#read -p "Api Bot Token: " api
#read -p "Admin ID Telegram: " id
#echo "$api" > /etc/funny/.keybot
